CREATE TABLE "{{DATABASE}}"."functional_classes" (
...
INSERT INTO "{{DATABASE}}"."functional_classes" (name, parent_id)
...
LEFT JOIN "{{DATABASE}}"."functional_classes" f ON val.parent_name = f.name;
